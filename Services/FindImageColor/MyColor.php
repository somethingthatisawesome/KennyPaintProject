<?php
/**
 * MyColor utility and conversion
 * 
...
class MyColor
{
     ...
     * @return int
     */
    public function getDistanceRgbFrom(MyColor $color)
    {
        $rgb1 = $this->toRgbInt();
        $rgb2 = $color->toRgbInt();
     ...
     * @return float
     */
    public function getDistanceLabFrom(MyColor $color)
    {
        $lab1 = $this->toLabCie();
        $lab2 = $color->toLabCie();
     ...
     * 
     * @param array $colors array of integers or MyColor objects
     * 
    ...
    public function getClosestMatch(array $colors)
    {
        ...
        foreach($colors as $key => $color) {
            if (false === ($color instanceof MyColor)) {
                $c = new MyColor($color);
            }
